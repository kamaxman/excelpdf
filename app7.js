      ...
      const docDefinition = {
        ...
        footer: function(currentPage, pageCount) {
          return {
            columns: [
              {
                image: 'logo.png', // Ganti dengan path gambar logo Anda
                width: 50,
                alignment: 'left' // Logo diletakkan di sebelah kiri
              },
              {
                text: currentPage.toString() + ' / ' + pageCount,
                alignment: 'right' // Nomor halaman diletakkan di sebelah kanan
              }
            ],
            margin: [10, 0, 10, 10], // Margin atas, kanan, bawah, kiri untuk footer
            width: 595.28 // Lebar halaman A4
          };
        },
        pageMargins: [20, 20, 20, 20], // Margin atas, kanan, bawah, kiri untuk halaman
        ...
        styles: {
          header: {
            ...
            bold: true,
            alignment: 'center',
            margin: [0, 0, 0, 10] // Margin atas, kanan, bawah, kiri untuk header
          },
          subheader: {
            fontSize: 16,
            bold: true,
            margin: [0, 10, 0, 5] // Margin atas, kanan, bawah, kiri untuk subheader
          },
          tableHeader: {
            bold: true,
            fontSize: 13,
